...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "change-me-inprod")
...
def read_key_file(path, key_name=""):
    """Read key file and return content"""
    try:
...
# Read keys
JWT_PRIVATE_KEY = read_key_file(JWT_PRIVATE_KEY_PATH, "JWT_PRIVATE_KEY")
JWT_PUBLIC_KEY = read_key_file(JWT_PUBLIC_KEY_PATH, "JWT_PUBLIC_KEY")
...
# Simple JWT Configuration - REMOVE the import from rest_framework_simplejwt.settings
SIMPLE_JWT = {
    "ALGORITHM": "RS256",
